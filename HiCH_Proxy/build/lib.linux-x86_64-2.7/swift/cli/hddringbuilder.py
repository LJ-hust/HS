...
from swift.common.ring import Ring, RingBuilder
from swift.common.ring.builder import MAX_BALANCE, HDDRingBuilder
...
swift-ring-builder <builder_file> create <part_power> <replicas>
    ...
    than once.
        ...
        if len(argv) < 6:
            ...
            exit(EXIT_ERROR)
        builder =HDDRingBuilder(int(argv[3]), float(argv[4]), int(argv[5]))
...
swift-ring-builder <builder_file> search
    ...
    once.
        ...
        for dev in devs:
            ...
            except exceptions.HDDRingBuilderError as e:
                print '-' * 79
                print(
...
def main(arguments=None):
    ...
    try:
        builder = HDDRingBuilder.load(builder_file)
